...
{
    [AddComponentMenu("")]
    public class ClientSimUdonManager : ClientSimBehaviour, IClientSimSDKManager
    {
        private static ClientSimUdonManager instance_;
        ...
        protected override void Awake()
        {
            if (instance_ != null)
            {
                this.LogError("Already have an instance of ClientSimUdonManager!");
